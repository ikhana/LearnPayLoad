...
> **TS Lessons:** [03.1 — Literal types](../ts-lessons/03-restricting-values/03-1-literal-types.md), [03.2 — Union types](../ts-lessons/03-restricting-values/03-2-union-types.md)
>
